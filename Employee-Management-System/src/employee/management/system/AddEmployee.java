...
public class AddEmployee extends JFrame implements ActionListener{
    ...
    AddEmployee() {
        ...
        String courses[] = {"BBA", "BCA", "BA", "BSCIT", "B.COM", "BTech", "MBA", "MCA", "MA", "MTech", "MSCIT", "PHD"};
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == add) {
            ...
            String date1,a1,a2;
            date1=dob.substring(4, 10);
            a1=dob.substring(23, 28);
            a2=date1+a1;
            System.out.print(a2);
...
//            }
            ...
            try {
                Conn conn = new Conn();
                String query = "insert into employee values('"+name+"', '"+fname+"', '"+a2+"', '"+salary+"', '"+address+"', '"+phone+"', '"+email+"', '"+education+"', '"+designation+"', '"+aadhar+"', '"+empId+"')";
